...
describe("EmailValidateEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BUSINESSDAYCALCULATOR_TEST_EMAIL_VALIDATE_ENTID JSON to run live")
      return
    end
...
function email_validate_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BUSINESSDAYCALCULATOR_TEST_EMAIL_VALIDATE_ENTID")
  ...
  if env["BUSINESSDAYCALCULATOR_TEST_LIVE"] == "TRUE" then

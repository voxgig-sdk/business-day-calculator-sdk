# BusinessDayCalculator Lua SDK



The Lua SDK for the BusinessDayCalculator API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/business-day-calculator-sdk/releases)),
...
```
lua/
├── business-day-calculator_sdk.lua    -- Main SDK module
...
The main module (`business-day-calculator_sdk`) exports the SDK constructor

...
|---|---|---|
| `ts/` | @voxgig-sdk/business-day-calculator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/business-day-calculator-sdk \
      --repository voxgig-sdk/business-day-calculator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/business-day-calculator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/business-day-calculator-sdk --id=<id>` removes it.

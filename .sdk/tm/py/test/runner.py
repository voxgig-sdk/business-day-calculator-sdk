...
class BusinessDayCalculatorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BusinessDayCalculatorTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = BusinessDayCalculatorTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = BusinessDayCalculatorTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

...
def make_error_util(ctx, err):
    if ctx is None:
        ...
        ctx = BusinessDayCalculatorContext({}, None)
    ...
    result = ctx.result
    if result is None:
        result = BusinessDayCalculatorResult({})
    result.ok = False
    ...
    errmsg = ""
    if isinstance(err, BusinessDayCalculatorError):
        errmsg = err.msg
    ...
    sdk_err = BusinessDayCalculatorError("", msg, ctx)

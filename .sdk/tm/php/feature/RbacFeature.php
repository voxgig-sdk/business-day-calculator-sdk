...
// BusinessDayCalculator SDK rbac feature
...
class BusinessDayCalculatorRbacFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _required(BusinessDayCalculatorContext $ctx): ?string
    {
    ...
    private function _reject(BusinessDayCalculatorContext $ctx, string $required): void
    {
    ...
    private function _track(BusinessDayCalculatorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

...
// BusinessDayCalculator SDK proxy feature
...
class BusinessDayCalculatorProxyFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    public function init(BusinessDayCalculatorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BusinessDayCalculatorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

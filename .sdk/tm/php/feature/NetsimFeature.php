...
// BusinessDayCalculator SDK netsim feature
...
class BusinessDayCalculatorNetsimFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _simulate(BusinessDayCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BusinessDayCalculatorContext $ctx, array $applied): void
    {
        $client = $this->client;

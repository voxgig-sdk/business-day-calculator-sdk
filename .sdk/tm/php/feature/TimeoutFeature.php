...
// BusinessDayCalculator SDK timeout feature
...
class BusinessDayCalculatorTimeoutFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _with_timeout(BusinessDayCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BusinessDayCalculatorContext $_ctx, float $ms): void
    {
        $client = $this->client;

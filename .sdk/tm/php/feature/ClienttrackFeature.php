...
// BusinessDayCalculator SDK clienttrack feature
...
class BusinessDayCalculatorClienttrackFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    public function PostConstruct(BusinessDayCalculatorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BusinessDayCalculator-SDK';

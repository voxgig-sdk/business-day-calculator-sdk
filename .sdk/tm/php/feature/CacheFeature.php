...
// BusinessDayCalculator SDK cache feature
...
class BusinessDayCalculatorCacheFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _through(BusinessDayCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
// BusinessDayCalculator SDK utility: fetcher

class BusinessDayCalculatorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BusinessDayCalculatorSDK/1.0)';
    ...
    public static function call(BusinessDayCalculatorContext $ctx, string $fullurl, array $fetchdef): array
    {

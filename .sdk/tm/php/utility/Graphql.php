...
// BusinessDayCalculator SDK utility: graphql
//
...
class BusinessDayCalculatorGraphql
{
    ...
    // equivalent.
    public static function body(BusinessDayCalculatorContext $ctx): mixed
    {
    ...
    public static function errors(BusinessDayCalculatorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

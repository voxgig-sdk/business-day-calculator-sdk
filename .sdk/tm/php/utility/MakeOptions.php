...
// BusinessDayCalculator SDK utility: make_options

class BusinessDayCalculatorMakeOptions
{
    ...
    public static function call(BusinessDayCalculatorContext $ctx): array
    {
        ...
        //
        // `BusinessDayCalculatorSchema::optspec()` is built from the model:
        ...
        $optspec = BusinessDayCalculatorSchema::optspec();

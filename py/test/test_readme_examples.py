# BusinessDayCalculator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BusinessDayCalculatorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BusinessDayCalculatorSDK(...) and BusinessDayCalculatorSDK.test(...) become
#      BusinessDayCalculatorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "businessdaycalculator_sdk"
_SDK_CLASS = "BusinessDayCalculatorSDK"

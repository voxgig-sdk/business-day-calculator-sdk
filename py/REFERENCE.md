# BusinessDayCalculator Python SDK Reference

Complete API reference for the BusinessDayCalculator Python SDK.
...
#### `BusinessDayCalculatorSDK.test(testopts=None, sdkopts=None)`

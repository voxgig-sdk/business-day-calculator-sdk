...
from businessdaycalculator_sdk.utility import register

# Load features
from businessdaycalculator_sdk.feature.base_feature import BusinessDayCalculatorBaseFeature
from businessdaycalculator_sdk.features import _has_feature, _make_feature


class BusinessDayCalculatorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BusinessDayCalculatorUtility()
        self._utility = utility

        from businessdaycalculator_sdk.config import shared_config
    ...
    def get_utility(self):
        return BusinessDayCalculatorUtility.copy(self._utility)
    ...
    def prepare(self, fetchargs=None):
        ...
        ctx.spec = BusinessDayCalculatorSpec({
            "base": base,
            "prefix": prefix,
            "suffix": suffix,
            "path": path,
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "BusinessDayCalculatorSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BusinessDayCalculatorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DnsResult(self, data=None) -> "DnsResultEntity":
        ...
        from businessdaycalculator_sdk.entity.dns_result_entity import DnsResultEntity
    ...
    def Domain(self, data=None) -> "DomainEntity":
        ...
        from businessdaycalculator_sdk.entity.domain_entity import DomainEntity
    ...
    def EmailValidate(self, data=None) -> "EmailValidateEntity":
        ...
        from businessdaycalculator_sdk.entity.email_validate_entity import EmailValidateEntity
    ...
    def Generate(self, data=None) -> "GenerateEntity":
        ...
        from businessdaycalculator_sdk.entity.generate_entity import GenerateEntity
    ...
    def Utility(self, data=None) -> "UtilityEntity":
        ...
        from businessdaycalculator_sdk.entity.utility_entity import UtilityEntity
        return UtilityEntity(self, data)


    def Whoi(self, data=None) -> "WhoiEntity":
        """Entity factory: client.Whoi().list() / client.Whoi().load({"id": ...})."""
        from businessdaycalculator_sdk.entity.whoi_entity import WhoiEntity
        return WhoiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BusinessDayCalculatorSDK":
        if sdkopts is None:
            sdkopts = {}

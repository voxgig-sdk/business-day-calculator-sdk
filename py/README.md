# BusinessDayCalculator Python SDK



The Python SDK for the BusinessDayCalculator API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/business-day-calculator-sdk/releases)) or
...
client = BusinessDayCalculatorSDK({
    "apikey": os.environ.get("BUSINESS_DAY_CALCULATOR_APIKEY"),
})
```
...
client = BusinessDayCalculatorSDK(options)
```
...
```
py/
├── businessdaycalculator_sdk.py         -- Main SDK module

...
- `business-day-calculator_list`: List records for an entity. Supported entities: `domain`, `ssl`, `whoi`.
- `business-day-calculator_load`: Load one record for an entity. Supported entities: `dns_result`, `email_validate`, `generate`, `ipn`, `utility`.

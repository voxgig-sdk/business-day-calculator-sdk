...
```bash
cd go-mcp && go build -o business-day-calculator-mcp .
```
...
```json
{
  "mcpServers": {
    "business-day-calculator": {
      "command": "/abs/path/to/business-day-calculator-mcp"
    }
  }
}
```
...
```go
import sdk "github.com/voxgig-sdk/business-day-calculator-sdk/go"

# BusinessDayCalculator TypeScript SDK



The TypeScript SDK for the BusinessDayCalculator API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/business-day-calculator-sdk/releases](https://github.com/voxgig-sdk/business-day-calculator-sdk/releases)
...
```ts
const client = BusinessDayCalculatorSDK.test()
...
```ts
const client = new BusinessDayCalculatorSDK({ apikey: '...' })
...
```ts
new BusinessDayCalculatorSDK(options?: {
  apikey?: string
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `BusinessDayCalculatorSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `BusinessDayCalculatorSDK.test(testopts?, sdkopts?)` | `BusinessDayCalculatorSDK` | Create a test-mode client. |
...
| `client` | `client(): BusinessDayCalculatorSDK` | Return the parent SDK client. |
...
├── src/
│   ├── BusinessDayCalculatorSDK.ts        # Main SDK class

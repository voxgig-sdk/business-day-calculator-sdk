# BusinessDayCalculator TypeScript SDK Reference

Complete API reference for the BusinessDayCalculator TypeScript SDK.
...
```ts
new BusinessDayCalculatorSDK(options?: object)
```
...
#### `BusinessDayCalculatorSDK.test(testopts?, sdkopts?)`
...
**Returns:** `BusinessDayCalculatorSDK` instance in test mode.
...
Alias for `BusinessDayCalculatorSDK.test()`.
...
Return the parent `BusinessDayCalculatorSDK` instance.

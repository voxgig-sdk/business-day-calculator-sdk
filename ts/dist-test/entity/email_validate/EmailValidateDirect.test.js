...
(0, node_test_1.describe)('EmailValidateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BusinessDayCalculatorSDK({
...
function liveScenariosActive() { return false && process.env.BUSINESS_DAY_CALCULATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'BUSINESS_DAY_CALCULATOR_TEST_EMAIL_VALIDATE_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.BusinessDayCalculatorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.BUSINESS_DAY_CALCULATOR_APIKEY,
        }));
        let idmap = env['BUSINESS_DAY_CALCULATOR_TEST_EMAIL_VALIDATE_ENTID'];
    ...
    const client = new __1.BusinessDayCalculatorSDK({
        base: 'http://localhost:8080',

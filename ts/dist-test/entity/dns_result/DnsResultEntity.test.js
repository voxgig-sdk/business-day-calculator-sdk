...
(0, node_test_1.describe)('DnsResultEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set BUSINESS_DAY_CALCULATOR_TEST_DNS_RESULT_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['BUSINESS_DAY_CALCULATOR_TEST_DNS_RESULT_ENTID'];
    ...
    idmap = env['BUSINESS_DAY_CALCULATOR_TEST_DNS_RESULT_ENTID'];

...
function envOverride(m) {
    if ('TRUE' === process.env.BUSINESS_DAY_CALCULATOR_TEST_LIVE ||
        'TRUE' === process.env.BUSINESS_DAY_CALCULATOR_TEST_OVERRIDE) {
    ...
    m.BUSINESS_DAY_CALCULATOR_TEST_EXPLAIN = process.env.BUSINESS_DAY_CALCULATOR_TEST_EXPLAIN || m.BUSINESS_DAY_CALCULATOR_TEST_EXPLAIN;
    return m;
}

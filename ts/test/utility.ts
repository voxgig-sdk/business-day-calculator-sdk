...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.BUSINESSDAYCALCULATOR_TEST_LIVE ||
    'TRUE' === process.env.BUSINESSDAYCALCULATOR_TEST_OVERRIDE
  ) {
  ...
  m.BUSINESSDAYCALCULATOR_TEST_EXPLAIN = process.env.BUSINESSDAYCALCULATOR_TEST_EXPLAIN || m.BUSINESSDAYCALCULATOR_TEST_EXPLAIN

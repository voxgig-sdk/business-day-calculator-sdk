...
declare class BusinessDayCalculatorSDK {
    _mode: string;
    _options: any;
    _utility: Utility;
    _features: Feature[];
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): BusinessDayCalculatorSDK;
    tester(testopts?: any, sdkopts?: any): BusinessDayCalculatorSDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof BusinessDayCalculatorSDK;
export { stdutil, config, BaseFeature, BusinessDayCalculatorEntityBase, BusinessDayCalculatorSDK, SDK, };

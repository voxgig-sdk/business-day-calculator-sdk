// Command BusinessDayCalculator-cli is a CLI + REPL for the BusinessDayCalculator SDK,
...
const prompt = "business-day-calculator"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BUSINESS_DAY_CALCULATOR_APIKEY (api key), BUSINESS_DAY_CALCULATOR_BASE (base url override)")

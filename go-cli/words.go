...
func registerSDKWords(r *eng.Registry, client *sdk.BusinessDayCalculatorSDK) {
...
func runOp(client *sdk.BusinessDayCalculatorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

...
func registerTools(server *mcp.Server, client *sdk.BusinessDayCalculatorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "business-day-calculator_list",
		Description: "List records from BusinessDayCalculator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "business-day-calculator_load",
		Description: "Load a single record from BusinessDayCalculator. " +
...
func runOp(client *sdk.BusinessDayCalculatorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BusinessDayCalculatorSDK, name string) (sdk.BusinessDayCalculatorEntity, error) {

# BusinessDayCalculator Golang SDK Reference

Complete API reference for the BusinessDayCalculator Golang SDK.


## BusinessDayCalculatorSDK
...
#### `TestSDK(testopts, sdkopts map[string]any) *BusinessDayCalculatorSDK`

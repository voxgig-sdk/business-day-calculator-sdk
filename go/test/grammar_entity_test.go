...
func TestGrammarEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set BUSINESSDAYCALCULATOR_TEST_GRAMMAR_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func grammarBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BUSINESSDAYCALCULATOR_TEST_GRAMMAR_ENTID")
	...
	idmapResolved := core.ToMapAny(env["BUSINESSDAYCALCULATOR_TEST_GRAMMAR_ENTID"])

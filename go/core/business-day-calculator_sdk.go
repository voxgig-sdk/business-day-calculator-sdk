...
import (
	...
	vs "github.com/voxgig-sdk/business-day-calculator-sdk/go/utility/struct"
)

type BusinessDayCalculatorSDK struct {
	Mode     string
...
func (sdk *BusinessDayCalculatorSDK) OptionsMap() map[string]any {
...
func (sdk *BusinessDayCalculatorSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BusinessDayCalculatorSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BusinessDayCalculatorSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BusinessDayCalculatorSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BusinessDayCalculatorSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BusinessDayCalculatorSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BusinessDayCalculatorSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BusinessDayCalculatorSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BusinessDayCalculatorSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BusinessDayCalculatorSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *BusinessDayCalculatorSDK) DnsResult(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) Domain(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) EmailValidate(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) Generate(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) Grammar(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) Ipn(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) Redact(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) Ssl(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) Utility(data map[string]any) BusinessDayCalculatorEntity {
...
func (sdk *BusinessDayCalculatorSDK) Whoi(data map[string]any) BusinessDayCalculatorEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *BusinessDayCalculatorSDK {
	...
	sdk := NewBusinessDayCalculatorSDK(sdkopts)
	sdk.Mode = "test"

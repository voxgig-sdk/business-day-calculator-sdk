# BusinessDayCalculator Ruby SDK Reference

Complete API reference for the BusinessDayCalculator Ruby SDK.
...
#### `BusinessDayCalculatorSDK.test(testopts = nil, sdkopts = nil)`

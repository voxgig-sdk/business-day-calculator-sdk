...
#      offline in seeded test mode (BusinessDayCalculatorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BusinessDayCalculator_sdk.rb")
  SDK_CLASS = "BusinessDayCalculatorSDK"
  ...
  SDK_BASE = "BusinessDayCalculator_sdk"

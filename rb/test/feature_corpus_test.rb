# BusinessDayCalculator SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # BusinessDayCalculatorSDK.new, not BusinessDayCalculatorSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    BusinessDayCalculatorSDK.new(opts)
  end

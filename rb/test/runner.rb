...
module BusinessDayCalculatorTestRunner
  ...
  def self.env_override(m)
    live = getenv("BUSINESSDAYCALCULATOR_TEST_LIVE")
    override = getenv("BUSINESSDAYCALCULATOR_TEST_OVERRIDE")
    ...
    explain = getenv("BUSINESSDAYCALCULATOR_TEST_EXPLAIN")
    m["BUSINESSDAYCALCULATOR_TEST_EXPLAIN"] = explain if explain && !explain.empty?

...
module BusinessDayCalculatorTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("BUSINESS_DAY_CALCULATOR_TEST_LIVE")
    override = getenv("BUSINESS_DAY_CALCULATOR_TEST_OVERRIDE")
    ...
    explain = getenv("BUSINESS_DAY_CALCULATOR_TEST_EXPLAIN")
    m["BUSINESS_DAY_CALCULATOR_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BusinessDayCalculatorTestRunner
Helpers = BusinessDayCalculatorHelpers
Vs = VoxgigStruct

...
// BusinessDayCalculator SDK utility: result_basic

class BusinessDayCalculatorResultBasic
{
    public static function call(BusinessDayCalculatorContext $ctx): ?BusinessDayCalculatorResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BusinessDayCalculatorError) ? $result->err->msg : (string)$result->err;

...
// BusinessDayCalculator SDK utility: feature_init

class BusinessDayCalculatorFeatureInit
{
    public static function call(BusinessDayCalculatorContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {

...
// BusinessDayCalculator SDK streaming feature
...
class BusinessDayCalculatorStreamingFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _iterate(BusinessDayCalculatorResult $result): \Generator
    {
    ...
    private function _streamable(BusinessDayCalculatorContext $ctx): bool
    {

...
// BusinessDayCalculator SDK audit feature
...
class BusinessDayCalculatorAuditFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _emit(BusinessDayCalculatorContext $ctx, string $outcome): void
    {

...
// BusinessDayCalculator SDK metrics feature
...
class BusinessDayCalculatorMetricsFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _record(BusinessDayCalculatorContext $ctx, bool $ok): void
    {

...
// BusinessDayCalculator SDK debug feature
...
class BusinessDayCalculatorDebugFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _finish(BusinessDayCalculatorContext $ctx, bool $ok): void
    {

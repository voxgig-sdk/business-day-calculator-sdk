...
// BusinessDayCalculator SDK paging feature
...
class BusinessDayCalculatorPagingFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _is_list(BusinessDayCalculatorContext $ctx): bool
    {

...
// BusinessDayCalculator SDK telemetry feature
...
class BusinessDayCalculatorTelemetryFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _close(BusinessDayCalculatorContext $ctx, bool $ok): void
    {

...
// BusinessDayCalculator SDK ratelimit feature
...
class BusinessDayCalculatorRatelimitFeature extends BusinessDayCalculatorBaseFeature
{
    ...
    private function _acquire(BusinessDayCalculatorContext $ctx): void
    {
    ...
    private function _track(BusinessDayCalculatorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

...
// BusinessDayCalculator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BusinessDayCalculatorSDK::test)
...
{
    private const SDK_CLASS = 'BusinessDayCalculatorSDK';
    ...
    private const SDK_BASE = 'businessdaycalculator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../businessdaycalculator_sdk.php';

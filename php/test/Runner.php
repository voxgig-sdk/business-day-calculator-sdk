...
class BusinessDayCalculatorTestRunner
{
    ...
    {
        $live = self::getenv('BUSINESSDAYCALCULATOR_TEST_LIVE');
        $override = self::getenv('BUSINESSDAYCALCULATOR_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BUSINESSDAYCALCULATOR_TEST_EXPLAIN');

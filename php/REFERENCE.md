# BusinessDayCalculator PHP SDK Reference

Complete API reference for the BusinessDayCalculator PHP SDK.
...
#### `BusinessDayCalculatorSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): BusinessDayCalculatorUtility`

...
// BusinessDayCalculator SDK utility type

class BusinessDayCalculatorUtility
{
    ...
    public static function copy(BusinessDayCalculatorUtility $src): BusinessDayCalculatorUtility
    {
        $u = new BusinessDayCalculatorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
